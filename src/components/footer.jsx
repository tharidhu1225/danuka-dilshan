      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* WhatsApp */}
            <a
              href="https://wa.me/94763793551" // Replace with your number (Ex: 94+771234567)
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* Call */}
            <a
              href="tel:+94763793551" // Replace with your phone number
              className="bg-gray-700 p-2 rounded-full hover:bg-gray-800 transition"
            >
              <FaPhoneAlt size={20} />
            </a>
          </div>
          <p className="text-sm text-gray-500 mt-4">Call us: +94 76 379 3551</p>
        </div>
      </div>

      {/* Bottom Footer */}
<div className="border-t border-gray-700 mt-8 pt-6 pb-4 text-center text-sm text-gray-400 bg-gray-900">
  <div className="max-w-4xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-2">
    ...
    <div>
      <span className="text-gray-500">Design your website?</span>{" "}
      <a
        href="tel:+94761918718"
